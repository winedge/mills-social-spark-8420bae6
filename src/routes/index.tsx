  ...
  return (
    <div className="bg-background text-foreground font-body">
      ...
      <section className="relative h-[55vh] min-h-[440px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 animate-slide-up max-w-3xl">
          <span className="block font-mono text-accent text-xs md:text-sm mb-3 tracking-[0.3em]">
            TEMPE, AZ · MODERN SPORTS SOCIAL
          </span>
          <h2 className="font-display text-3xl md:text-5xl lg:text-6xl uppercase leading-[1.1] tracking-tight mb-4 text-balance">
            Where Tempe comes to watch, eat & celebrate
          </h2>
          <p className="text-muted-foreground max-w-md mx-auto mb-6 text-pretty">
