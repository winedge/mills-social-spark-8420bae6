      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div className="bg-accent/5 p-10 md:p-12 border border-accent/20 flex flex-col justify-between gap-12">
          ...
          <div className="flex gap-6">
            <a href={contact?.instagram_url || "#"} target="_blank" rel="noreferrer" className="text-xs font-bold uppercase tracking-widest hover:text-accent">Instagram</a>
            <a href={contact?.x_url || "#"} target="_blank" rel="noreferrer" className="text-xs font-bold uppercase tracking-widest hover:text-accent">X / Twitter</a>
            <a href={contact?.tiktok_url || "#"} target="_blank" rel="noreferrer" className="text-xs font-bold uppercase tracking-widest hover:text-accent">TikTok</a>
          </div>
        </div>
      </div>
